...
public class Shipping {
    ...
    public Shipping(Integer distance, Integer cod, Boolean express, Integer insurefee) {
    ...
    public Shipping(Integer distance, Integer cod, Integer insurefee) {
        this.distance = distance;
        this.cod = cod;
        this.insurefee = insurefee;
    }

    public Shipping(Boolean express, Integer distance) {
        this.express = express;
        this.distance = distance;
    }
